...
namespace Portfolio.Models
{
    ...
    public class Course
    {
        ...
        [StringLength(100)]
        public string Category { get; set; } = "Backend"; // backend, frontend, database

        [StringLength(50)]
        public string PriceType { get; set; } = "paid"; // free, paid
        ...
        // Foreign Key Relationship (1 Course -> Many Enrollments)
